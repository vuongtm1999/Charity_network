...
class Post(models.Model):
    ...
    tags = models.ManyToManyField('PostTag', null=True, related_name="posts")
...
class Like(models.Model):
    # Khoa ngoai tham chieu toi Model User'
    # related_name="user_likes" la de trong UserViewSet co the gọi trong User Id nào đó
